...
void winwin()
{
  ...
  if (stepc == 0) 
          ...
          stepc=1;
                  delay(1000);
          servoM.writeMicroseconds(2280);
          delay(1000);
          servoF.writeMicroseconds(715);
          servoM.writeMicroseconds(1500);
          delay(1000);
                }
                else if ((modnum==2)||(modnum==4))
                {
          stepc=1;
          servoB.write(5);
          servoL.write(0);
          if(modnum==2)servoR.write(0);
                  delay(1000);
          servoF.writeMicroseconds(710);
          delay(1000);
          servoF.writeMicroseconds(1500);
          servoM.writeMicroseconds(2290);
          delay(1000);
                }
  ...
  {
    case 1:
      posM=1500+270*sin((vel*t));   
      posF=1100+270*sin((vel*t)); 
      servoM.writeMicroseconds(posM);
      servoF.writeMicroseconds(posF);
    break;
    ...
    break;
    case 2:
      posM=1900+340*sin((vel*t)+1.57);   
      posF=1500+340*sin((vel*t)+2.35); 
      servoM.writeMicroseconds(posM);
      servoF.writeMicroseconds(posF);
    break;
    case 4:
